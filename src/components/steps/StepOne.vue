...
// Validerer at form navn er min. 3 tegn
  ...
  <div class="create-form">
    <div class="create-form__form-group">
      <input
        ...
        :class="{
          'form-group__input--invalid':
            props.modelValue.name.length > 0 && !isFormNameValid,
      ...
      <div class="form-group__error-handling">
        <p
          v-if="props.modelValue.name.length > 0 && !isFormNameValid"
          class="error-handling__message--error"
        >
    ...
    <div class="create-form__form-group custom-select-wrapper">
      ...
      <select
        ...
        @change="
          emit('update:modelValue', {
            ...props.modelValue,
            options: { ...props.modelValue.options, frequency: $event.target.value },
          })
        "
      >
    ...
    <div class="create-form__form-group">
      <label for="receiverOfBill" class="form-group__form-label"
        >Modtager af kvittering</label
      >
      <select
        id="receiverOfBill"
        class="form-group__input custom-select"
        ...
        @change="
          emit('update:modelValue', {
            ...props.modelValue,
            options: { ...props.modelValue.options, receiverOfBill: $event.target.value },
          })
        "
      >
    ...
    <div class="create-form__form-group">
      <label for="receiverOfDeviation" class="form-group__form-label"
        >Modtager af afvigelse</label
      >
      <select
        ...
        @change="
          emit('update:modelValue', {
            ...
            options: {
              ...props.modelValue.options,
              receiverOfDeviation: $event.target.value,
            },
          })
        "
      >
...
.checkbox-container__custom-checkbox.checked {
